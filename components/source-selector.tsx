  ...
  return (
    <div className="h-full bg-gray-800 overflow-y-auto">
      ...
      <div className="overflow-y-auto">
        {sources.map((s, i) => {
          let shortSourceName = path.basename(path.dirname(s.name)) + '/' + path.basename(s.name);

          return (
            <div
              className={classNames('whitespace-no-wrap text-white px-2 py-1 hover:bg-gray-500 cursor-pointer', {
